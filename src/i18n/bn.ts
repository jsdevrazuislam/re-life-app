export default {
  ...
  kycSecurityMessage: 'আপনার সমস্ত তথ্য এনক্রিপ্ট করা হবে এবং সম্পূর্ণ নিরাপদভাবে সংরক্ষণ করা হবে। এটি শুধুমাত্র আপনার পরিচয় যাচাইয়ের জন্য ব্যবহৃত হবে এবং অন্য কোনো উদ্দেশ্যে শেয়ার করা হবে না।',
  ...
  beggerPhoto: 'ভিক্ষুকের ছবি',
  beggerName: 'ভিক্ষুকের নাম',
  beggerNamePlaceholder: 'ভিক্ষুকের পুরো নাম লিখুন',
  ...
  hasChildren: 'ভিক্ষুকের সন্তান আছে কি?',
  ...
  profession: 'পেশা',
  professionPlaceholder: 'ভিক্ষুকের পেশা লিখুন',
