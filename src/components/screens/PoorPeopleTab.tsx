    ...
    <View style={imamStyles.tabContainer}>
        ...
        {data.length === 0 ? (
            <View style={imamStyles.emptyContainer}>
                ...
                <Heading level={6} weight='Bold' style={imamStyles.emptyTitle}>No people added yet</Heading>
                ...
                {data.map((item) => (
                    <View key={item?._id} style={imamStyles.infoCard}>
                        <View style={imamStyles.cardContent}>
                            <Image 
                                source={{ uri: "https://images.pexels.com/photos/30140435/pexels-photo-30140435/free-photo-of-moody-forest-in-heavy-fog.jpeg?auto=compress&cs=tinysrgb&w=800&lazy=load" }} 
